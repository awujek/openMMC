...
const struct stm32f3_adc_ch_def stm32f3_adc_ch_config[] = {
    [STM32F3_ADC_P3V3]      = { ADC1, ADC_Channel_6 },
    [STM32F3_ADC_P9V0_LO]   = { ADC1, ADC_Channel_8 },
    [STM32F3_ADC_P9V0_REF]  = { ADC1, ADC_Channel_9 },
    [STM32F3_ADC_P12V]      = { ADC1, ADC_Channel_3 },
    [STM32F3_ADC_POCXO]     = { ADC1, ADC_Channel_7 },
    [STM32F3_ADC_OCXO_CURR] = { ADC2, ADC_Channel_5 },
