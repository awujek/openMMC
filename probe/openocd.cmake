...
if(${DEBUG_PROBE_UPPERCASE} MATCHES "^(OPENOCD)$")
else()
...
add_custom_target(program_app
  ...
  COMMAND ${OPENOCD_BIN} -f openocd_flash.cfg -s ${CMAKE_SOURCE_DIR}/port/ucontroller/stm32/stm32f30x/ -c exit
  )
...
add_custom_target(debug_app
  ...
  COMMAND ${OPENOCD_BIN} -f openocd_flash.cfg -s ${CMAKE_SOURCE_DIR}/port/ucontroller/stm32/stm32f30x/
  )
